...
public class CardBinderItem extends Item implements MenuProvider
{
    ...
    public AbstractContainerMenu createMenu(int id, Inventory playerInv, Player player)
    {
        ...
        return new CardBinderContainer(DdContainerTypes.CARD_BINDER.get(), id, playerInv, getInventoryManager(s), s);
    }
    ...
    public UUID getUUID(ItemStack itemStack)
    {
        ...
        UUIDHolder holder = itemStack.getCapability(DuelDimension.UUID_HOLDER).orElse(UUIDHolder.NULL_HOLDER);
    ...
    {
        itemStack.getCapability(DuelDimension.UUID_HOLDER).ifPresent(holder -> holder.setUUID(uuid));
    }
    ...
    public CompoundTag getShareTag(ItemStack stack)
    {
        ...
        stack.getCapability(DuelDimension.UUID_HOLDER).ifPresent(holder -> finalNbt.put(MANAGER_UUID_KEY, holder.serializeNBT()));
        return finalNbt;
    }
    ...
    public void readShareTag(ItemStack stack, @Nullable CompoundTag nbt)
    {
        ...
        {
            stack.getCapability(DuelDimension.UUID_HOLDER).ifPresent(holder -> holder.deserializeNBT((StringTag) nbt.get(MANAGER_UUID_KEY)));
        }
    }
}
