...
{
    private static final ResourceLocation CARD_SUPPLY_GUI_TEXTURE = new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/card_supply.png");
    ...
    protected void onCardClicked(CardButton button, int index)
    {
        ...
        {
            DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new CardSupplyMessages.RequestCard(button.getCard().getCard(), button.getCard().getImageIndex()));
        }
    }
