...
public class FinalCardSetBakedModel implements BakedModel
{
    ...
    public FinalCardSetBakedModel(BakedModel mainModel)
    {
        ...
        quadsMap = new HashMap<>(DdDatabase.SETS_LIST.size());
    }
    ...
    public List<BakedQuad> getQuads(BlockState state, Direction side, RandomSource rand)
    {
        ...
        if(activeItemStack.getItem() == DdItems.OPENED_SET.get())
        {
        ...
        {
            CardSet set = DdItems.SET.get().getCardSet(activeItemStack);
    ...
    private List<BakedQuad> getSetList()
    {
        if(setList == null)
        {
            ResourceLocation rl = new ResourceLocation(DuelDimension.MOD_ID, "item/" + DuelDimension.proxy.addSetItemTag("blanc_set"));
    ...
    private List<BakedQuad> getOpenedList()
    {
        if(openedList == null)
        {
            ResourceLocation rl = new ResourceLocation(DuelDimension.MOD_ID, "item/" + DdItems.OPENED_SET.getId().getPath());
            TextureAtlasSprite sprite = textureGetter.apply(rl);
