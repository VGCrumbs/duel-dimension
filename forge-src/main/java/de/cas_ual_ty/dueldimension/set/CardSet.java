...
public class CardSet
{
    ...
    {
        return new ResourceLocation(DuelDimension.MOD_ID, "textures/item/" + DuelDimension.proxy.getSetInfoReplacementImage(this) + ".png");
    }
    
    public ResourceLocation getItemImageResourceLocation()
    {
        return new ResourceLocation(DuelDimension.MOD_ID, "item/" + getItemImageName());
    }
