...
{
    private static final DeferredRegister<ZoneType> DEFERRED_REGISTER = DeferredRegister.create(new ResourceLocation(DuelDimension.MOD_ID, "zone_types"), DuelDimension.MOD_ID);
