...
{
    private static final DeferredRegister<DuelMessageHeaderType> DEFERRED_REGISTER = DeferredRegister.create(new ResourceLocation(DuelDimension.MOD_ID, "duel_message_headers"), DuelDimension.MOD_ID);
