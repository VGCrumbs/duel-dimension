...
public class DuelMessageUtility
{
    ...
    {
        buf.writeRegistryIdUnsafe(DuelDimension.duelMessageHeaderRegistry.get(), header.type);
        header.writeToBuf(buf);
    }
    
    public static DuelMessageHeader decodeHeader(FriendlyByteBuf buf)
    {
        DuelMessageHeader header = buf.readRegistryIdUnsafe(DuelDimension.duelMessageHeaderRegistry.get()).createHeader();
    ...
    {
        buf.writeRegistryIdUnsafe(DuelDimension.actionTypeRegistry.get(), type);
    }
    
    public static ActionType decodeActionType(FriendlyByteBuf buf)
    {
        return buf.readRegistryIdUnsafe(DuelDimension.actionTypeRegistry.get());
    }
