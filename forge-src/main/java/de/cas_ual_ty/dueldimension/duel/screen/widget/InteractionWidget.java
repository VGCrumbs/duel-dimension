...
public class InteractionWidget extends Button
{
    ...
    public void renderButton(PoseStack ms, int mouseX, int mouseY, float partialTicks)
    {
        ...
        DdBlitUtil.blit(ms, x + (width - iconWidth) / 2, y + (height - iconHeight) / 2, iconWidth, iconHeight, icon.iconX, icon.iconY, icon.iconWidth, icon.iconHeight, icon.fileSize, icon.fileSize);
