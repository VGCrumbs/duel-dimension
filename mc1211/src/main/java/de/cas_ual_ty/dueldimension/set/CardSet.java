...
public class CardSet
{
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/" + DuelDimension.proxy.getSetInfoReplacementImage(this) + ".png");
    }
    
    public ResourceLocation getItemImageResourceLocation()
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "item/" + getItemImageName());
    }
