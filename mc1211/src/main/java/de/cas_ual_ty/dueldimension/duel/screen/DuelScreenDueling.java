...
import de.cas_ual_ty.dueldimension.clientutil.widget.*;
import de.cas_ual_ty.dueldimension.duel.DuelContainer;
import de.cas_ual_ty.dueldimension.duel.DuelPhase;
import de.cas_ual_ty.dueldimension.duel.action.*;
import de.cas_ual_ty.dueldimension.duel.network.DuelMessages;
import de.cas_ual_ty.dueldimension.duel.playfield.*;
import de.cas_ual_ty.dueldimension.duel.screen.animation.*;
import de.cas_ual_ty.dueldimension.duel.screen.widget.*;
...
public class DuelScreenDueling<E extends DuelContainer> extends DuelContainerScreen<E> implements IDuelScreenContext
{
    ...
    protected void init()
    {
        ...
        addRenderableWidget(reloadButton = new TextureButton(x, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.reload"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 64, 0, 16, 16));
        addRenderableWidget(flipViewButton = new TextureButton(x + quarterSize, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.flip_view"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 80, 0, 16, 16));
        addRenderableWidget(offerDrawButton = new TextureButton(x + 2 * quarterSize, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.offer_draw"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 96, 0, 16, 16));
        addRenderableWidget(admitDefeatButton = new TextureButton(x + 3 * quarterSize, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.admit_defeat"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 112, 0, 16, 16));
        ...
        {
            addRenderableWidget(new SmallTextWidget(x, y + 3 * quarterSize, zoneSize, quarterSize, () -> Component.translatable("container." + DuelDimension.MOD_ID + ".duel.spectating")));
        }
        ...
        addRenderableWidget(coinFlipButton = new TextureButton(x, y, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.coin_flip"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 32, 0, 16, 16));
        addRenderableWidget(diceRollButton = new TextureButton(x + halfSize, y, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.dice_roll"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 48, 0, 16, 16));
        addRenderableWidget(addCounterButton = new TextureButton(x, y + halfSize, halfSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.add_counter"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 128, 0, 16, 8));
        addRenderableWidget(removeCounterButton = new TextureButton(x, y + halfSize + quarterSize, halfSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.remove_counter"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 128, 8, 16, 8));
        addRenderableWidget(advancedOptionsButton = new TextureButton(x + halfSize, y + halfSize, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.advanced_options"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 144, 0, 16, 16));
        ...
        addRenderableWidget(prevPhaseButton = new ColoredButton(x, y + halfSize, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.left_arrow"), this::rightButtonClicked, this::rightButtonHovered));
        addRenderableWidget(nextPhaseButton = new ColoredButton(x + halfSize, y + halfSize, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.right_arrow"), this::rightButtonClicked, this::rightButtonHovered));
    ...
    protected void initChat(int width, int height, int x, int y, int w, int h, int chatWidth, int chatHeight, int margin, int buttonHeight)
    {
        ...
        addRenderableWidget(scrollUpButton = Button.builder(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.up_arrow"), this::scrollButtonClicked).bounds(x, y, w, buttonHeight).build());
        y += offset;
        ...
        addRenderableWidget(scrollDownButton = Button.builder(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.down_arrow"), this::scrollButtonClicked).bounds(x, y, w, buttonHeight).build());
        y += offset;
    }
        ...
        float partialTicks)
    {
        ...
        // dropping either one would be a guess about which plate is expected.
        ...
        DdBlitUtil.blitTexels(ms, DuelContainerScreen.DUEL_FOREGROUND_GUI_TEXTURE, leftPos, topPos, 0, 0, imageWidth, imageHeight, DdBlitUtil.NO_TINT);
    ...
    protected void findAndPopulateInteractions(ZoneWidget widget, boolean isAdvanced)
    {
        ...
        // The Forge code appended to renderables and children by hand because
        // interactions come and go between inits; renderables is private now and
        // addRenderableWidget is what reaches both.
        for(InteractionWidget w : interactionWidgets)
        {
    ...
    {
        DuelDimension.proxy.sendDuelMessage(new DuelMessages.RequestDuelAction(getDuelManager().headerFactory.get(), action));
    }
    ...
    protected void middleButtonClicked(AbstractWidget w)
    {
        ...
        {
            DuelDimension.proxy.sendDuelMessage(new DuelMessages.SendAdmitDefeat(getHeader()));
        }
        else if(w == offerDrawButton)
        {
            DuelDimension.proxy.sendDuelMessage(new DuelMessages.SendOfferDraw(getHeader()));
        }
    }
    ...
    protected void zoneTooltip(AbstractWidget w0, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        ...
        {
            tooltip.add(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.counters").append(": " + w.zone.getCounters()).getVisualOrderText());
        }
        
        ms.setTooltipForNextFrame(font, tooltip, mouseX, mouseY);
    }
    
    protected void interactionTooltip(AbstractWidget w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        ms.setTooltipForNextFrame(font, w.getMessage(), mouseX, mouseY);
    }
    
    protected void viewCardStackTooltip(Renderable w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
    }
    
    protected void lpTooltip(ZoneOwner owner, @Nullable MutableComponent playerName, Renderable w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        ...
        ms.setTooltipForNextFrame(font, list, mouseX, mouseY);
    }
    
    protected void lpTooltipView(Renderable w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        lpTooltip(getView(), getViewName(), w, ms, mouseX, mouseY);
    }
    
    protected void lpTooltipViewOpponent(Renderable w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        lpTooltip(getView().opponent(), getViewOpponentName(), w, ms, mouseX, mouseY);
    }
    
    protected void lpTextFieldWidget(Renderable w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        List<FormattedCharSequence> list = new LinkedList<>();
        
        list.add(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.change_lp_tooltip1").getVisualOrderText());
        list.add(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.change_lp_tooltip2").getVisualOrderText());
        list.add(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.change_lp_tooltip3").getVisualOrderText());
        
        ms.setTooltipForNextFrame(font, list, mouseX, mouseY);
    }
    
    protected void phaseWidgetHovered(Renderable w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        ms.setTooltipForNextFrame(font, getCurrentPhaseTooltip(), mouseX, mouseY);
    }
    
    // PORT-NOTE: unwired. Forge passed this to the two scroll buttons as their
    // ITooltip; Button.builder takes no such argument, and the mod's own
    // ITooltip-carrying buttons all draw something extra, which these must not.
    // Nothing is lost while the hook is empty -- but a body added here would not
    // be called, so wire the buttons to a plain ITooltip button first.
    protected void scrollButtonHovered(AbstractWidget w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
    }
    
    protected void middleButtonHovered(AbstractWidget w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        if(w == reloadButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.reload"), mouseX, mouseY);
        }
        else if(w == flipViewButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.flip_view"), mouseX, mouseY);
        }
        else if(w == offerDrawButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.offer_draw"), mouseX, mouseY);
        }
        else if(w == admitDefeatButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.admit_defeat"), mouseX, mouseY);
        }
    }
    
    protected void leftButtonHovered(AbstractWidget w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        if(w == coinFlipButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.coin_flip"), mouseX, mouseY);
        }
        else if(w == diceRollButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.dice_roll"), mouseX, mouseY);
        }
        else if(w == addCounterButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.add_counter"), mouseX, mouseY);
        }
        else if(w == removeCounterButton)
        {
            ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.remove_counter"), mouseX, mouseY);
        }
        else if(w == advancedOptionsButton)
        {
            if(!isAdvanced)
            {
                ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.advanced_options"), mouseX, mouseY);
            }
            else
            {
                ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.basic_options"), mouseX, mouseY);
            }
        }
    }
    
    protected void rightButtonHovered(AbstractWidget w, GuiGraphicsExtractor ms, int mouseX, int mouseY)
    {
        DuelPhase phase = getPlayField().getPhase();
        ...
        if(w == prevPhaseButton)
        {
            ...
            {
                DuelPhase prevPhase = DuelPhase.getFromIndex((byte) (phase.getIndex() - 1));
                ms.setTooltipForNextFrame(font, (getPhaseTooltip(prevPhase).append(" ").append(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.left_arrow"))), mouseX, mouseY);
            }
        }
        else if(w == nextPhaseButton)
        {
            if(phase.isLast())
            {
                ms.setTooltipForNextFrame(font, Component.translatable("action." + DuelDimension.MOD_ID + ".end_turn"), mouseX, mouseY);
            }
            else
            {
                DuelPhase nextPhase = DuelPhase.getFromIndex((byte) (phase.getIndex() + 1));
                ms.setTooltipForNextFrame(font, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.right_arrow").append(" ").append(getPhaseTooltip(nextPhase)), mouseX, mouseY);
            }
        }
    }
    ...
    {
        return Component.translatable("container." + DuelDimension.MOD_ID + ".duel." + getPlayField().getPhase().local + ".short");
    }
    ...
    {
        return Component.translatable("container." + DuelDimension.MOD_ID + ".duel." + phase.local);
    }
    
    protected void removeInteractionWidgets()
    {
        // removeWidget is the only way at the private renderables list, and it
        // edits children() as it goes, so the matches are gathered first.
        List<GuiEventListener> found = new ArrayList<>();
        
        for(GuiEventListener w : children())
        {
            if(w instanceof InteractionWidget)
            {
                found.add(w);
            }
        }
        
        found.forEach(this::removeWidget);
    }
    ...
    {
        return Component.translatable("container." + DuelDimension.MOD_ID + ".duel.unknown_player")
    ...
    @Override
    public void renderCardInfo(GuiGraphicsExtractor ms, DuelCard card)
    {
        cardInfo = card;
    }
    
    public static void renderSelectedRect(GuiGraphicsExtractor ms, float x, float y, float w, float h)
    {
        ScreenUtil.drawLineRect(ms, x - 1, y - 1, w + 2, h + 2, 2, 0, 0, 1F, 1F);
    }
    
    public static void renderEnemySelectedRect(GuiGraphicsExtractor ms, float x, float y, float w, float h)
    {
        ScreenUtil.drawLineRect(ms, x - 1, y - 1, w + 2, h + 2, 2, 1F, 0, 0, 1F);
    }
    
    public static void renderBothSelectedRect(GuiGraphicsExtractor ms, float x, float y, float w, float h)
    {
