...
public class SpecialSummonAnimation extends Animation
{
    ...
    public void extractRenderState(GuiGraphicsExtractor ms, int mouseX, int mouseY, float partialTicks)
    {
        ...
        // Degrees on Forge (the Quaternion's fourth argument said so);
        // Matrix3x2f.rotate takes radians.
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/action_animations/special_summon.png");
    }
}
