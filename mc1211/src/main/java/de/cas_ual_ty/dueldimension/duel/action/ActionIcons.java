...
public class ActionIcons
{
    ...
    private static ActionIcon register(String name, ActionIcon entry)
    {
        return Registry.register(DdDuelRegistries.ACTION_ICONS,
            ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, name), entry);
    }
    ...
    {
        return new ActionIcon(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/action_icons/" + name + ".png"), 64);
    }
}