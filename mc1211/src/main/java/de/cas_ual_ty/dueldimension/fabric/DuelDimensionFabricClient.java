...
public class DuelDimensionFabricClient implements ClientModInitializer
{
    ...
    public void onInitializeClient()
    {
            ...
            (client, screen, width, height) ->
        {
            ...
            // setScreen while Minecraft's constructor is still running, which
            // renders a frame against a frame limiter that has not been built
            // yet -- a startup crash naming none of this.
