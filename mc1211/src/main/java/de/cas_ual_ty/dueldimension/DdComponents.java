...
public final class DdComponents
{
    ...
    public static void register()
    {
        ...
        Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE,
            ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "duel_player2"), DUEL_PLAYER2);
        Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE,
            ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "duel_manager"), DUEL_MANAGER);
    }
}
