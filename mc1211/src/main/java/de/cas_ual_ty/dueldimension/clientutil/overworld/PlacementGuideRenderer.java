...
public final class PlacementGuideRenderer
{
    ...
    private static final ResourceLocation MARKER =
        ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/duel/overworld/stand_marker.png");
    private static final ResourceLocation OUTLINE =
        ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/duel/overworld/field_outline.png");
    ...
    private static void drawQuad(PoseStack poseStack, SubmitNodeCollector collector,
        ResourceLocation texture, Vec3 camera, double x, double y, double z, float width, float depth,
        int tint)
    {
        poseStack.pushPose();
