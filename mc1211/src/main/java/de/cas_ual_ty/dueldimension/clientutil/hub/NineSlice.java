...
public final class NineSlice
{
     ...
     */
    private static void cell(GuiGraphicsExtractor graphics, ResourceLocation texture,
        int x, int y, int width, int height,
     ...
     */
    public static void tinted(GuiGraphicsExtractor graphics, ResourceLocation texture,
    ...
    public static void image(GuiGraphicsExtractor graphics, ResourceLocation texture,
        int x, int y, int width, int height)
    {
