...
public final class ModelLight
{
     ...
     */
    public static ModelLight around(BlockAndTintGetter level, AABB box)
    {
        ...
        for(int corner = 0; corner < 8; corner++)
        {
            ...
            // getBrightness rather than a packed helper: the type and the packing utility
     ...
     */
    public static ModelLight standing(BlockAndTintGetter level, Vec3 feet, double height)
    {
