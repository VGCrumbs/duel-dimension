...
public final class CardRenderer
{
    ...
    public static void submit(PoseStack poseStack, SubmitNodeCollector collector,
        ...
        boolean defence, float lift, ResourceLocation face, ResourceLocation back)
    {
    ...
    public static void submit(PoseStack poseStack, SubmitNodeCollector collector,
        CardSpace transform, Vec3 camera, FieldLayout.Rect zone, int controller,
        boolean defence, float lift, ResourceLocation face, ResourceLocation back, int tint)
    {
    ...
    public static void submitAt(PoseStack poseStack, SubmitNodeCollector collector,
        ...
        ResourceLocation face, ResourceLocation back, int tint)
    {
    ...
    private static void submitFace(PoseStack poseStack, SubmitNodeCollector collector,
        ...
        ResourceLocation face, ResourceLocation back, int tint)
    {
        ResourceLocation texture = switch(part.kind())
        {
            case FRONT -> face;
    ...
    public static void submitPile(PoseStack poseStack, SubmitNodeCollector collector,
        ...
        float lift, ResourceLocation top, ResourceLocation back)
    {
    ...
    public static void submitPile(PoseStack poseStack, SubmitNodeCollector collector,
        CardSpace transform, Vec3 camera, FieldLayout.Rect zone, int controller, int count,
        float lift, ResourceLocation top, ResourceLocation back, int tint)
    {
        if(count <= 0)
        {
            return;
        ...
        for(CardMesh.Face part : CardMesh.faces(rect, lift, height))
        {
            ...
            ResourceLocation texture = part.kind() == CardMesh.Kind.FRONT ? top : back;
    ...
    public static void submitTurning(PoseStack poseStack, SubmitNodeCollector collector,
        CardSpace transform, Vec3 camera, FieldLayout.Rect rect, int turns, float lift,
        float tilt, float yaw, float hop, ResourceLocation face, ResourceLocation back, int tint)
    {
