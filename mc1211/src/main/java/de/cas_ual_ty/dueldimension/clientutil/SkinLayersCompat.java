...
{
    private record Key(ResourceLocation texture, boolean slim)
    {
    }
    ...
    public static void apply(PlayerModel model, ResourceLocation texture, boolean slim)
    {
     ...
     */
    public static void applyFirstPerson(PlayerModel model, ResourceLocation texture, boolean slim)
    {
        if(!AVAILABLE || model == null || texture == null)
        {
            return;
