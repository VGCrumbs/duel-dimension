...
public class ClientProxy implements ISidedProxy
{
    ...
    public static void loadConfig()
    {
        ...
        de.cas_ual_ty.dueldimension.clientutil.DuelCamera.load();
        ChainSettings.load();
    ...
    {
        net.minecraft.client.gui.screens.Screen open = getMinecraft().screen;
        if(!state.open())
        {
        ...
        java.util.List<String> sources)
    {
        ...
        getMinecraft().setScreen(
            new de.cas_ual_ty.dueldimension.clientutil.hub.PackOpeningScreen(
                getMinecraft().screen, setName, codes, rarities, fresh, sources));
    }
