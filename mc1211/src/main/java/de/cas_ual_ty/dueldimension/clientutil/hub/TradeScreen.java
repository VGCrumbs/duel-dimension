...
public class TradeScreen extends Screen
{
    ...
    static final ResourceLocation SLOT = gui("trade/slot_empty.png");
    private static final ResourceLocation SLOT_READY = gui("trade/slot_ready.png");
    private static final ResourceLocation READY = gui("trade/ready.png");
    private static final ResourceLocation WAITING = gui("trade/waiting.png");
    private static final ResourceLocation DP = gui("trade/dp.png");
    private static final ResourceLocation SIDE = gui("trade/side.png");
    private static final ResourceLocation SIDE_READY = gui("trade/side_ready.png");
    private static final ResourceLocation HEAD = gui("trade/head.png");
    private static final ResourceLocation HEAD_READY = gui("trade/head_ready.png");
    private static final ResourceLocation BANNER = gui("trade/banner.png");
    private static final ResourceLocation ARROWS = gui("trade/arrows.png");
    ...
    public boolean mouseClicked(double vanillaX, double vanillaY, int vanillaButton)
    {
        ...
        minecraft.setScreen(new TradePickScreen(this, slot));
        return true;
    }
        ...
        int mouseY, float partialTick)
    {
        ...
        // immediately from render(). The body below is unchanged.
