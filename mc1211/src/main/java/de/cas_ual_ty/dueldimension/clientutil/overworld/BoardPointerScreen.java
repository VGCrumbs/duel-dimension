...
public class BoardPointerScreen extends Screen
{
    ...
    private void drawChoices(GuiGraphicsExtractor extractor, int mouseX, int mouseY)
    {
        ...
        for(int row = 0; row < choices.size(); row++)
        {
            ...
            int textX = x + 5;
            net.minecraft.resources.ResourceLocation icon = iconFor(index);
            if(icon != null)
            {
                int size = rowH - 4;
     ...
     */
    private net.minecraft.resources.ResourceLocation iconFor(int index)
    {
    ...
    {
        List<net.minecraft.resources.ResourceLocation> faces =
