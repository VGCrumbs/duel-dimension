...
public enum PlayMats
{
    ...
    private final ResourceLocation worldTexture;
    ...
    PlayMats(String id, String displayName, int accent)
    {
        ...
        this.accent = accent;
        this.texture = ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID,
            "textures/duel/mats/" + id + ".png");
        this.worldTexture = ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID,
