 ...
 * {@code ResourceLocation}s. Both are presentation, both are version-specific, and
...
public final class CardPresentation
{
    ...
    // the ResourceLocation: the proxy is where a resource pack's replacement art is
    ...
    public static ResourceLocation infoImage(Properties card, byte imageIndex)
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/"
            + DuelDimension.proxy.getCardInfoReplacementImage(card,
                card.adjustImageIndex(imageIndex)) + ".png");
    }

    public static ResourceLocation itemImage(Properties card, byte imageIndex)
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID,
            "item/" + itemImageName(card, imageIndex));
    }

    public static ResourceLocation mainImage(Properties card, byte imageIndex)
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/"
    ...
    public static ResourceLocation infoImage(CardHolder holder)
    {
        return infoImage(holder.getCard(), holder.getImageIndex());
    }

    public static ResourceLocation itemImage(CardHolder holder)
    {
        return itemImage(holder.getCard(), holder.getImageIndex());
    }

    public static ResourceLocation mainImage(CardHolder holder)
    {
