...
public class CharacterScreen extends Screen
{
        ...
        int mouseY, float partialTick)
    {
        ...
        // Widgets last: the buttons have to be drawn after the panel they sit
        // on, the same order 26.2 needs for the same reason.
     ...
     * Which it did: the panel, the labels and the character in the middle of it
     * all went soft while the buttons drawn afterwards stayed sharp. The dim
     * this screen wants is its own, and goes down first.
     */
    @Override
    ...
    {
        if(colours != null && colours.mouseClicked(mouseX, mouseY))
        {
            applyColour();
            return true;
        }
    ...
    {
        if(colours != null && colours.mouseDragged(mouseX, mouseY))
        {
            applyColour();
            return true;
        }
