...
public final class DestinyPrompt
{
    ...
    public static void render(de.cas_ual_ty.dueldimension.compat.GuiGraphicsExtractor poseStack, Font font, int width, int height,
    ...
    private static void choice(de.cas_ual_ty.dueldimension.compat.GuiGraphicsExtractor poseStack, Font font, int[] box, int mouseX,
        int mouseY, net.minecraft.resources.ResourceLocation icon, String label, String detail)
    {
