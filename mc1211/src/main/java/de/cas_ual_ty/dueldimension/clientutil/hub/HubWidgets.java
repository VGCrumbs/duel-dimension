...
public final class HubWidgets
{
    ...
    public static class CheckBox extends TextureButton
    {
        ...
        @Override
        protected void renderWidget(net.minecraft.client.gui.GuiGraphics vanillaGraphics,
        ...
        protected void renderWidget(net.minecraft.client.gui.GuiGraphics vanillaGraphics, int mouseX, int mouseY, float partialTick)
    {
        ...
        GuiGraphicsExtractor graphics = new GuiGraphicsExtractor(vanillaGraphics);
            ...
            else
            {
                ...
                // The budget is in TEXT pixels, so it is divided by the scale --
            ...
            float y, float wantedScale, int colour)
        {
            ...
            // deck editor's card counts and preview already went through this;
            // the list of decks did not.
            //
