...
{
    public static final ResourceLocation CARD = ResourceLocation.fromNamespaceAndPath(
        DuelDimension.MOD_ID, "card");
    public static final ResourceLocation CARD_SET = ResourceLocation.fromNamespaceAndPath(
        DuelDimension.MOD_ID, "card_set");
    /** The cards on a worn duel disk; see {@link DiskCardsItemModel}. */
    public static final ResourceLocation DUEL_DISK_CARDS = ResourceLocation.fromNamespaceAndPath(
