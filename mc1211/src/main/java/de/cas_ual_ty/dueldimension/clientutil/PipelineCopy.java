...
final class PipelineCopy
{
     ...
     *                        an {@link ResourceLocation} and not a string: the
     *                        builder's String overload runs
     *                        {@code ResourceLocation.withDefaultNamespace}, so a mod
    ...
    static RenderPipeline of(RenderPipeline base, String name,
        @Nullable ResourceLocation fragmentShader, @Nullable BlendFunction blend)
    {
        ...
        @Nullable PrimitiveTopology topology)
    {
        RenderPipeline.Builder builder = RenderPipeline.builder()
            .withLocation(ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID,
                "pipeline/" + name))
