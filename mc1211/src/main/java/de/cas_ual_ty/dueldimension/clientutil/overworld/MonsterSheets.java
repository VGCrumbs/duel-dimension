...
public final class MonsterSheets
{
    ...
    private static final Map<String, ResourceLocation> IMPORTED = new HashMap<>();
     ...
     */
    public static ResourceLocation resolve(String sheet)
    {
        ResourceLocation imported = IMPORTED.get(sheet.toLowerCase(Locale.ROOT));
     ...
     */
    public static int[] size(ResourceLocation texture)
    {
