...
public class FoilTestScreen extends Screen
{
    ...
    private static final ResourceLocation CARD = ResourceLocation.fromNamespaceAndPath(
        DuelDimension.MOD_ID, "textures/gui/duel_background.png");
    /** Stands in for a foil layer. */
    private static final ResourceLocation FOIL = ResourceLocation.fromNamespaceAndPath(
