...
public final class CardFaces
{
    ...
    public static ResourceLocation back(int controller)
    {
        if(controller != 0)
        {
     ...
     */
    public static ResourceLocation face(BoardSnapshot.Slot slot, boolean inHand, int controller)
    {
     ...
     */
    public static ResourceLocation underside(BoardSnapshot.Slot slot, int controller)
    {
        if(slot.code() == 0)
        {
            return back(controller);
    ...
    public static Window window(ResourceLocation texture)
    {
        return isCardShaped(texture) ? WHOLE : LETTERBOXED;
    }

    public static boolean isCardShaped(ResourceLocation texture)
    {
