...
public class BanlistPickerScreen extends Screen
{
    ...
    {
        // 26.2 describes itself into a render state; 1.21.1 draws now. The body
        // below is unchanged -- it is handed the compatibility surface over the
        // real GuiGraphics, exactly as the other pickers are.
        GuiGraphicsExtractor graphics = new GuiGraphicsExtractor(vanillaGraphics);

        // fillGradient rather than renderBackground, for the reason
    ...
    /**
     * No background from vanilla: this screen draws its own dim before
     * {@code super.render}, and vanilla's blurs. Same refusal as the editor's.
     */
    @Override
