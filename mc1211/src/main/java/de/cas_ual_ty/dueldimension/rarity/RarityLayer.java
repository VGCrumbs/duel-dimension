...
public class RarityLayer
{
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/" + DuelDimension.proxy.getRarityMainImage(this) + ".png");
    }
    
    public ResourceLocation getInfoImageResourceLocation()
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/" + DuelDimension.proxy.getRarityInfoImage(this) + ".png");
    }
