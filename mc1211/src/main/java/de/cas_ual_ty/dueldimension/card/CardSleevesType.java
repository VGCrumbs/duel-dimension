...
public enum CardSleevesType
{
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/" + size + "/" + getResourceName() + ".png");
    }
    ...
    public ResourceLocation getItemModelRL(int size)
    {
        ...
        {
            return ResourceLocation.fromNamespaceAndPath(DuelDimension.MOD_ID, getResourceName() + "_" + size);
        }
    }
