...
public class CustomCards
{
    ...
    public static void createAndRegisterEverything()
    {
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_001_PROPERTIES); // Wants Secret Rare
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_002_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_003_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_004_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_005_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_006_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_007_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_008_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_009_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_010_PROPERTIES);
        ...
        DdDatabase.PROPERTIES_LIST.add(CustomCards.PATREON_011_PROPERTIES);
    }
