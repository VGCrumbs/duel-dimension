...
{
    private static final DeferredRegister<ActionIcon> DEFERRED_REGISTER = DeferredRegister.create(new ResourceLocation(DuelDimension.MOD_ID, "action_icons"), DuelDimension.MOD_ID);
    ...
    {
        return new ActionIcon(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/action_icons/" + name + ".png"), 64);
    }
}