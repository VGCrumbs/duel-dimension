...
{
    private static final DeferredRegister<ActionType> DEFERRED_REGISTER = DeferredRegister.create(new ResourceLocation(DuelDimension.MOD_ID, "action_types"), DuelDimension.MOD_ID);
