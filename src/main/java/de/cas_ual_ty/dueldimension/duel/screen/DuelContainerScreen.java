...
{
    public static final ResourceLocation DUEL_FOREGROUND_GUI_TEXTURE = new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_foreground.png");
    public static final ResourceLocation DUEL_BACKGROUND_GUI_TEXTURE = new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_background.png");
    ...
    protected void initChat(int width, int height, int x, int y, int w, int h, int chatWidth, int chatHeight, int margin, int buttonHeight)
    {
        ...
        addRenderableWidget(duelChatButton = new Button(x, y, halfW, buttonHeight, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.duel_chat"), (b) -> switchChat()));
        addRenderableWidget(worldChatButton = new Button(x + halfW - extraOff, y, halfW + extraOff, buttonHeight, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.world_chat"), (b) -> switchChat()));
        y += offset;
        
        addRenderableWidget(chatUpButton = new Button(x, y, w, buttonHeight, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.up_arrow"), this::chatScrollButtonClicked, this::chatScrollButtonHovered));
        y += offset;
        ...
        addRenderableWidget(chatDownButton = new Button(x, y, w, buttonHeight, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.down_arrow"), this::chatScrollButtonClicked, this::chatScrollButtonHovered));
        y += offset;
    ...
    protected void sendChat()
    {
        ...
        if(!text.isEmpty())
        {
            if(duelChat)
            {
                DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.SendMessageToServer(getHeader(), Component.literal(text)));
            }
            else
            {
