...
public class DuelScreenIdle<E extends DuelContainer> extends DuelContainerScreen<E>
{
    ...
    {
        DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.SelectRole(getHeader(), ((RoleButtonWidget) button).role));
    }
    ...
    protected void ready1ButtonClicked()
    {
        ...
        {
            DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.RequestReady(getHeader(), !getDuelManager().player1Ready));
        }
    }
    ...
    protected void ready2ButtonClicked()
    {
        ...
        {
            DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.RequestReady(getHeader(), !getDuelManager().player2Ready));
        }
    }
}
