...
public class DuelScreenDueling<E extends DuelContainer> extends DuelContainerScreen<E> implements IDuelScreenContext
{
    ...
    protected void init()
    {
        ...
        addRenderableWidget(reloadButton = new TextureButton(x, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.reload"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 64, 0, 16, 16));
        addRenderableWidget(flipViewButton = new TextureButton(x + quarterSize, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.flip_view"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 80, 0, 16, 16));
        addRenderableWidget(offerDrawButton = new TextureButton(x + 2 * quarterSize, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.offer_draw"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 96, 0, 16, 16));
        addRenderableWidget(admitDefeatButton = new TextureButton(x + 3 * quarterSize, y, quarterSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.admit_defeat"), this::middleButtonClicked, this::middleButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 112, 0, 16, 16));
        ...
        addRenderableWidget(coinFlipButton = new TextureButton(x, y, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.coin_flip"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 32, 0, 16, 16));
        addRenderableWidget(diceRollButton = new TextureButton(x + halfSize, y, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.dice_roll"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 48, 0, 16, 16));
        addRenderableWidget(addCounterButton = new TextureButton(x, y + halfSize, halfSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.add_counter"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 128, 0, 16, 8));
        addRenderableWidget(removeCounterButton = new TextureButton(x, y + halfSize + quarterSize, halfSize, quarterSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.remove_counter"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 128, 8, 16, 8));
        addRenderableWidget(advancedOptionsButton = new TextureButton(x + halfSize, y + halfSize, halfSize, halfSize, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.advanced_options"), this::leftButtonClicked, this::leftButtonHovered)
                .setTexture(new ResourceLocation(DuelDimension.MOD_ID, "textures/gui/duel_widgets.png"), 144, 0, 16, 16));
    ...
    protected void initChat(int width, int height, int x, int y, int w, int h, int chatWidth, int chatHeight, int margin, int buttonHeight)
    {
        ...
        addRenderableWidget(scrollUpButton = new Button(x, y, w, buttonHeight, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.up_arrow"), this::scrollButtonClicked, this::scrollButtonHovered));
        y += offset;
        ...
        addRenderableWidget(scrollDownButton = new Button(x, y, w, buttonHeight, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.down_arrow"), this::scrollButtonClicked, this::scrollButtonHovered));
        y += offset;
    }
    ...
    {
        DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.RequestDuelAction(getDuelManager().headerFactory.get(), action));
    }
    ...
    protected void middleButtonClicked(AbstractWidget w)
    {
        ...
        {
            DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.SendAdmitDefeat(getHeader()));
        }
        else if(w == offerDrawButton)
        {
            DuelDimension.channel.send(PacketDistributor.SERVER.noArg(), new DuelMessages.SendOfferDraw(getHeader()));
        }
    }
    ...
    protected void middleButtonHovered(AbstractWidget w, PoseStack ms, int mouseX, int mouseY)
    {
        if(w == reloadButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.reload"), mouseX, mouseY);
        }
        else if(w == flipViewButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.flip_view"), mouseX, mouseY);
        }
        else if(w == offerDrawButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.offer_draw"), mouseX, mouseY);
        }
        else if(w == admitDefeatButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.admit_defeat"), mouseX, mouseY);
        }
    }
    ...
    protected void leftButtonHovered(AbstractWidget w, PoseStack ms, int mouseX, int mouseY)
    {
        if(w == coinFlipButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.coin_flip"), mouseX, mouseY);
        }
        else if(w == diceRollButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.dice_roll"), mouseX, mouseY);
        }
        else if(w == addCounterButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.add_counter"), mouseX, mouseY);
        }
        else if(w == removeCounterButton)
        {
            renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.remove_counter"), mouseX, mouseY);
        }
        else if(w == advancedOptionsButton)
        {
            if(!isAdvanced)
            {
                renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.advanced_options"), mouseX, mouseY);
            }
            else
            {
                renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.basic_options"), mouseX, mouseY);
            }
        }
    }
    ...
    protected void rightButtonHovered(AbstractWidget w, PoseStack ms, int mouseX, int mouseY)
    {
        ...
        if(w == prevPhaseButton)
        {
            ...
            {
                DuelPhase prevPhase = DuelPhase.getFromIndex((byte) (phase.getIndex() - 1));
                renderTooltip(ms, (getPhaseTooltip(prevPhase).append(" ").append(Component.translatable("container." + DuelDimension.MOD_ID + ".duel.left_arrow"))), mouseX, mouseY);
            }
        }
        else if(w == nextPhaseButton)
        {
            if(phase.isLast())
            {
                renderTooltip(ms, Component.translatable("action." + DuelDimension.MOD_ID + ".end_turn"), mouseX, mouseY);
            }
            else
            {
                DuelPhase nextPhase = DuelPhase.getFromIndex((byte) (phase.getIndex() + 1));
                renderTooltip(ms, Component.translatable("container." + DuelDimension.MOD_ID + ".duel.right_arrow").append(" ").append(getPhaseTooltip(nextPhase)), mouseX, mouseY);
            }
        }
    }
