...
public final class ArenaRenderer
{
    ...
    private static final Identifier CORNER_MARK = Identifier.fromNamespaceAndPath(
        DuelDimension.MOD_ID, "textures/duel/overworld/field_outline.png");
    private static final Identifier POINT_MARK = Identifier.fromNamespaceAndPath(
    ...
    private static void drawQuad(PoseStack poseStack, SubmitNodeCollector collector,
        Identifier texture, Vec3 camera, BlockPos at, int tint)
    {
        poseStack.pushPose();
