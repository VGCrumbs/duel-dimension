...
public final class DisplayCard
{
    ...
    {
        Identifier face = CardFaces.face(slotOf(code, art, defence, faceDown), false, 0);
        Identifier back = CardFaces.underside(slotOf(code, art, defence, faceDown), 0);
        ...
        Identifier side = DuelTextures.STACK_SIDE;
    ...
    private static void quad(PoseStack poseStack, SubmitNodeCollector collector,
        Identifier texture, int tint, float[][] uv, Vec3 a, Vec3 b, Vec3 c, Vec3 d)
    {
