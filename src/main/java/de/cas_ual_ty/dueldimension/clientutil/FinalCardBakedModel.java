...
public class FinalCardBakedModel implements BakedModel
{
    ...
    public FinalCardBakedModel(BakedModel mainModel)
    {
        ...
        quadsMap = new HashMap<>(DdDatabase.PROPERTIES_LIST.size());
    }
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState pState, @Nullable Direction pDirection, RandomSource pRandom)
    {
        ...
        {
            CardHolder card = DdItems.CARD.get().getCardHolder(activeItemStack);
    ...
    private List<BakedQuad> getSingleBackList()
    {
        ...
        {
            ResourceLocation rl = new ResourceLocation(DuelDimension.MOD_ID, "item/" + DuelDimension.proxy.addCardItemTag("card_back"));
    ...
    private List<BakedQuad> getBlancList()
    {
        if(blancList == null)
        {
            ResourceLocation rl = new ResourceLocation(DuelDimension.MOD_ID, "item/" + DuelDimension.proxy.addCardItemTag("blanc_card"));
            TextureAtlasSprite sprite = textureGetter.apply(rl);
