...
{
    private static final Identifier CARD_SUPPLY_GUI_TEXTURE = Identifier.fromNamespaceAndPath(de.cas_ual_ty.dueldimension.DuelDimension.MOD_ID, "textures/gui/card_supply.png");
