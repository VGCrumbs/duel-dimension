...
public class Properties
{
    ...
    {
        return new ResourceLocation(DuelDimension.MOD_ID, "textures/item/" + DuelDimension.proxy.getCardInfoReplacementImage(this, adjustImageIndex(imageIndex)) + ".png");
    }
    
    public ResourceLocation getItemImageResourceLocation(byte imageIndex)
    {
        return new ResourceLocation(DuelDimension.MOD_ID, "item/" + getItemImageName(imageIndex));
    }
    
    public ResourceLocation getMainImageResourceLocation(byte imageIndex)
    {
        return new ResourceLocation(DuelDimension.MOD_ID, "textures/item/" + DuelDimension.proxy.getCardMainReplacementImage(this, adjustImageIndex(imageIndex)) + ".png");
    }
