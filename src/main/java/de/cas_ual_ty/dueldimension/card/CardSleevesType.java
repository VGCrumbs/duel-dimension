...
public enum CardSleevesType
{
    ...
    {
        return new ResourceLocation(DuelDimension.MOD_ID, "textures/item/" + size + "/" + getResourceName() + ".png");
    }
    ...
    public ResourceLocation getItemModelRL(int size)
    {
        ...
        {
            return new ResourceLocation(DuelDimension.MOD_ID, getResourceName() + "_" + size);
        }
    }
    ...
    public Item getItem()
    {
        return ForgeRegistries.ITEMS.getValue(new ResourceLocation(DuelDimension.MOD_ID, getResourceName()));
    }
