...
public enum CardSleevesType
{
    ...
    {
        return Identifier.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/item/" + size + "/" + getResourceName() + ".png");
    }
    ...
    public Identifier getItemModelRL(int size)
    {
        ...
        {
            return Identifier.fromNamespaceAndPath(DuelDimension.MOD_ID, getResourceName() + "_" + size);
        }
    }
