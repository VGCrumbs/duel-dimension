...
public class WorkerManager
{
    ...
    public static void init()
    {
        ...
        {
            DuelDimension.forceTaskStop = true;
            ...
            for(Task t : TaskQueue.TASK_QUEUE)
            {
                ...
                DuelDimension.MOD_ID_UP + " shutdown hook");
    ...
    {
        WorkerManager.WORKERS[index] = new Worker(DuelDimension.MOD_ID_UP + " Worker Thread " + (index + 1), index, WorkerManager.sleepMillis);
        WorkerManager.WORKERS[index].start();
        DuelDimension.log("Initialized Worker " + index);
    }
