...
public class DeckBuilder
{
        ...
        return () ->
        {
            ...
            for(Entry e : errors)
            {
                if(!sentErrors.contains(e.getErrorString()))
                {
                    ...
                    DuelDimension.log("Deck Builder Entry gives null: " + e.getErrorString());
    ...
    private static class IdEntry extends Entry
    {
        ...
        {
            Properties p = DdDatabase.PROPERTIES_LIST.getFirst((c) -> c.getId() == id);
    ...
    private static class NameEntry extends Entry
    {
        ...
        public CardHolder get()
        {
            Properties p = DdDatabase.PROPERTIES_LIST.getFirst((c) -> c.getName().equals(name));
