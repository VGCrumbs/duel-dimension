...
{
    public static final Identifier DUEL_FOREGROUND_GUI_TEXTURE = Identifier.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_foreground.png");
    public static final Identifier DUEL_BACKGROUND_GUI_TEXTURE = Identifier.fromNamespaceAndPath(DuelDimension.MOD_ID, "textures/gui/duel_background.png");
