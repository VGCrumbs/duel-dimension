...
public final class OverworldBoardRenderer
{
    ...
    public static void render(LevelRenderContext context)
    {
        ...
        //
        // running(), not locked(): a watcher is never locked -- that is what
        // stops the duel taking their controls -- but the board is exactly what
        ...
        int location, int asked, int controller, int sequence)
    {
        ...
        if(mesh != null)
        {
            ...
            de.cas_ual_ty.dueldimension.clientutil.model.ModelHologram.submit(poseStack,
                ...
                // Lit by the room it is standing in. A world render event
                // may read the level directly -- the extract/submit split
                // that the pedestal obeys is a block entity renderer's rule,
                // and this is not one.
