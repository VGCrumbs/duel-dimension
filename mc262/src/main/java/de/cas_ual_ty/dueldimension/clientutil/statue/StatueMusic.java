...
public final class StatueMusic extends AbstractTickableSoundInstance
{
     ...
     * <p>
     * The verdict is checked because two of the engine's three answers are
     * silence with no exception: NOT_STARTED means it refused the sound, and
     * STARTED_SILENTLY means it accepted it and opened no channel because the
     * volume worked out to zero. Both have happened on this screen.
     *
     * @return the instance, or null if it never started
     */
    private static StatueMusic play(Minecraft minecraft, StatueMusic sound)
    {
        ...
        de.cas_ual_ty.dueldimension.DuelDimension.warn(
            "Statue music did not start (" + result + ")");
        return null;
    }
