...
public class CardShopScreen extends Screen
{
    ...
    public void extractRenderState(GuiGraphicsExtractor poseStack, int mouseX, int mouseY, float partialTick)
    {
        ...
        // In front of the screen rather than merely after part of it -- and it
        // was not even last: three more passes and super follow this line.
    ...
    private void drawPackArt(GuiGraphicsExtractor poseStack, ShopStock.Pack pack, int x, int y, int w, int h)
    {
        ...
        // Through the smooth identifier: every icon here is drawn well under
        // its authored size -- a 512 product icon lands in a 30-pixel tile --
        // and the plain path carries no sampling metadata for a downloaded
        // one, which is nearest and shimmers.
