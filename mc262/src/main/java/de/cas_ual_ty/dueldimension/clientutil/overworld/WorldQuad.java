...
public final class WorldQuad
{
        ...
        Identifier texture)
    {
        return switch(kind)
        {
            case SOLID -> net.minecraft.client.renderer.rendertype.RenderTypes
                .entityCutout(texture);
            case FADING -> net.minecraft.client.renderer.rendertype.RenderTypes
                .entityTranslucent(texture);
            case GLOW -> net.minecraft.client.renderer.rendertype.RenderTypes
                .breezeWind(texture, 0F, 0F);
            case EMISSIVE -> net.minecraft.client.renderer.rendertype.RenderTypes
                .breezeWind(texture, 0F, 0F);
        };
    }
