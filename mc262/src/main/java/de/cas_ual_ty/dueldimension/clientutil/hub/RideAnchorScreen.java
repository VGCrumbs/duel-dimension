...
public class RideAnchorScreen extends Screen
{
    ...
    public boolean keyPressed(KeyEvent event)
    {
        ...
        // The modifiers ride on the EVENT here, where 1.21.1 keeps them as
        // statics on Screen. Same two questions, asked of the thing that
        // actually knows the answer.
        if(event.key() == org.lwjgl.glfw.GLFW.GLFW_KEY_Z && event.hasControlDown())
        {
